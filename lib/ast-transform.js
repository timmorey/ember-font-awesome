...
class FaIconComponent extends BuildTimeComponent {
  constructor(node, opts = { tagName: 'i', ariaHidden: true, attributeBindings: [], classNameBindings: [] }) {
    opts.classNames = ['fa'];
    opts.attributeBindings = ['title', 'ariaLabel:aria-label', 'ariaHidden:aria-hidden:true', 'style'];
